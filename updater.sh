...
sudo cp $HOME/massa/massa-client/wallet.dat $HOME/massa_buckup/wallet.dat
sudo cp $HOME/massa/massa-node/config/node_privkey.key $HOME/massa_buckup/node_privkey.key
sudo apt upgrade -y
...
echo -e "\033[0;31m$HOME/massa_buckup/\e[0m\n\n"
